...
CREATE TABLE public.appointments (
  ...
  notes TEXT,
  recurrence_type TEXT CHECK (recurrence_type IN ('none', 'monthly', 'semiannual', 'annual')),
...
INSERT INTO public.locations (organization_id, name, address) VALUES 
  ((SELECT id FROM public.organizations LIMIT 1), 'Clínica Evolui', 'Balneário Camboriú'),
  ((SELECT id FROM public.organizations LIMIT 1), 'Clínica Riviera', 'Praia Brava - Itajaí'),
  ((SELECT id FROM public.organizations LIMIT 1), 'Clínica Ariele Mello', 'Balneário Camboriú');